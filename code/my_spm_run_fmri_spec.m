function out = my_spm_run_fmri_spec(job,p)

% FUNCTION my_spm_run_fmri_spec.m
% Modification of SPM function spm_run_fmri_spec to test custom basis functions
...
SPM.xBF          = my_spm_get_bf(SPM.xBF,p); %**********************************************MODIFIED CCH
if isempty(job.sess),
